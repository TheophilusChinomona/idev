...
command: /evolve
implementation: python3 ${CLAUDE_PLUGIN_ROOT}/skills/auto-learning/scripts/instinct-cli.py evolve
---
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/auto-learning/scripts/instinct-cli.py evolve [--generate]
```
